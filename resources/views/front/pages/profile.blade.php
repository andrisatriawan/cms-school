            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-12 text-left">
                        <h1 class="text-white mb-4 animated slideInDown">{{ $profile->title }}</h1>
                        <p class="item-text text-white">Terakhir diubah {{ lastUpdate($profile->updated_at) }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="clearfix">
                        @if ($profile->photo)
                            <img src="{{ asset('client/profile') . '/' . $profile->photo }}"
