                            ...
                            <fieldset>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-10">
                                        ...
                                        <div class="form-text">
                                            Jika kosong maka akan otomatis disetting by sistem
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-10">
                                        <input type="text" class="form-control" name="url" id="url"
                                            value="{{ $page->url }}" placeholder="https://">
                                        <div class="form-text">
                                ...
                                <div class="row mb-3">
                                    <label for="title" class="col-2 col-form-label">Icon</label>
                                    <div class="col-10">
                                        <input type="text" class="form-control" name="icon" id="icon"
                                            placeholder="fas fa-triangle" value="{{ $page->icon }}">
                                        <div class="form-text">
                                            <a href="https://fontawesome.com/v5/search" class="btn btn-primary btn-rounded"
                                                target="_blank">More Icons</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-10">
                                        <select name="header" id="header" class="form-control">
                                            <option value="1" {{ $page->header == '1' ? 'selected' : '' }}>Menu
                                                Lainnya</option>
                                            <option value="2" {{ $page->header == '2' ? 'selected' : '' }}>Section
                                                Layanan</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-10">
                                        <textarea name="deskripsi" id="deskripsi" rows="10">{{ $page->deskripsi }}</textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
...
@section('js')
    ...
    <script>
        ...
        $("#btn-simpan").on('click', function(e) {
            ...
            form.append('header', $("#header").val());
            form.append('deskripsi', deskripsi);
            form.append('foto', file);
            form.append('old_foto', "{{ $page->photo }}");
