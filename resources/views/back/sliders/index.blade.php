                ...
                <div class="card-body">
                    <div id="cardCollpase1" class="collapse show">
                        <div class="page-title-box mb-2">
                            ...
                            <h4 class="page-title"><a href="{{ route('admin.sliders-create') }}"
                                    class="btn btn-success btn-sm"><i class="mdi mdi-plus"></i> Tambah</a>
                            </h4>
                        </div>

                        <div class="table-responsive">
                            <table class="table dt-responsive w-100" id="table-sliders">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Title</th>
...
@section('js')
    ...
    <script>
        ...
        $("body").on('click', '.btn-delete', function(e) {
            ...
            Swal.fire({
                title: "Konfirmasi",
                text: "Apakah anda yakin ingin menghapus data page ini?",
                icon: "warning",
