            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-12 text-left">
                        <h1 class="text-white mb-4 animated slideInDown">{{ $article->title }}</h1>
                        <p class="item-text text-white">Terakhir diubah {{ lastUpdate($article->updated_at) }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-xxl py-6" id="blog">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="clearfix">
                        <img src="{{ asset('client/blog') . '/' . $article->photo }}"
